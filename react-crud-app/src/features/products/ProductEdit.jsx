...
const ProductEdit = ({
 ...
 const [newProductUnitsInStock, setNewProductUnitsInStock] = useState(productForEdit.unitsInStock);
 const [newProductUnitsOnOrder, setNewProductUnitsOnOrder] = useState(productForEdit.unitsOnOrder);
 const [newProductReorderLevel, setNewProductReorderLevel] = useState(productForEdit.reorderLevel);
 const [newProductDiscontinued, setNewProductDiscontinued] = useState(productForEdit.discontinued);
