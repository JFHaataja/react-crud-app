  ...
  return (
    <Container className='mt-4'>
       ...
       <Form onSubmit={handleSubmit} className="text-white text-start m-auto mt-3 mb-5">
        <Row>
          <Col sm={12} md={4}>
            <FormGroup formLabelText={"Customer ID"} inputType="text" inputValue={newCustomerId} inputPlaceholder="ID with 5 capital letters" inputMaxLength={"5"} inputMinLength={"5"} onChangeHandler={({ target }) => setNewCustomerId(target.value)} required />
